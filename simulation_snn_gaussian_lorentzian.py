...
"""
Script that performs a simulation of spiking neural networks of recurrently coupled Izhikevich neurons with either
Gaussian or Lorentzian distributions of spike thresholds across neurons.
...
ax.set_ylabel("count")
ax.set_title("Comparison between SNNs with Gaussian and Lorentzian spike threshold distributions")
ax = axes[1]
