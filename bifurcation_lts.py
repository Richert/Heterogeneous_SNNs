...
"""
Bifurcation analysis of the Izhikevich mean-field model with parameters representing an inhibitory low-threshold spiking
neuron.
...
n_dim = 4
n_params = 20
a = ODESystem("lts", working_dir="config", auto_dir=auto_dir, init_cont=False)
...
target = 0
a.run(starting_point='HB1', c='qif2', ICP=[6, 16], name='D/I:hb1', origin=f'I:{target+1}', NMX=4000, DSMAX=0.1,
...
ax.set_title(r'Bifurcation Diagram for Low-Threshold Spiking Neurons')
plt.tight_layout()
plt.show()
